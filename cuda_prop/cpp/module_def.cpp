...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("bandlimited_propagation_me_forward", &bandlimited_propagation_me_forward,
          "Bandlimited propagation ME forward (CUDA)");
    
    m.def("bandlimited_propagation_me_apply_aperture", &bandlimited_propagation_me_apply_aperture,
          "Bandlimited propagation ME apply aperture (CUDA)");
    
    m.def("bandlimited_propagation_me_backward", &bandlimited_propagation_me_backward,
          "Bandlimited propagation ME backward (CUDA)");
}